# GLM Tray Install Script for Windows
# Usage: irm https://raw.githubusercontent.com/kiwina/glm-tray/main/install.ps1 | iex
#
...
function Get-ReleaseVersion {
    ...
    Write-Host '  $Version = "0.1.0"; irm https://raw.githubusercontent.com/kiwina/glm-tray/main/install.ps1 | iex' -ForegroundColor Yellow
    return $false
}

function Get-DownloadUrl {
    # NSIS installer: glm-tray_0.1.0_x64-setup.exe
    $script:DownloadUrl = "https://github.com/$Repo/releases/download/v$($script:ReleaseVersion)/glm-tray_$($script:ReleaseVersion)_x64-setup.exe"
    $script:Filename = "glm-tray_$($script:ReleaseVersion)_x64-setup.exe"
